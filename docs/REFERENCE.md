...
- **Service-page imagery is best-fit, not curated per category.** Mapping today: landscape→services/landscape-design.jpg, patios→services/hardscape.jpg, retaining→before-after/ba-after.jpg, drainage→services/rock-features.jpg, decks→portfolio/IMG_5566.JPG (happens to be a real deck), transformations→before-after/ba2-after.jpg. Swap for dedicated per-service shots from the Drive when curated (see photo-curation item below).
